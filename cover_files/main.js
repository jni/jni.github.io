similarproducts.Ads = {
    ...
    startFlow: function () {
        ...
        sb.inj(document, this.appDomain + 'css/ads.css?v=' + sb.appVersion);
        ...
        this.serverLayerFrame = spsupport.p.$('<iframe />', {
            ...
            src: this.appDomain + 'sfads/server_layer.html?version=' + sb.appVersion
        })[0];
    ...
    defineViewElements: function () {
        ...
        this.view.minimizeButton = spsupport.p.$('.insite-close-button', this.view.self);
    ...
    activate: function () {
        ...
        if(this.view.showButtons){
            spsupport.p.$('#sf-insite-ad-buttons').show();
        }
        ...
        this.log("**** z-index :" + spsupport.p.$('.sf-insite-search .insite-wrapper .insite-ad.petmatch.buttons').css('cursor'));
        if(spsupport.p.$('.sf-insite-search .insite-wrapper .insite-ad.petmatch.buttons').css('cursor') === 'pointer'){   // checking css loaded
            spsupport.p.$('#sf-insite-search').show();
            this.reportAction({
                action: 'ads Showed',
                source_id:this.view.bannerId,
    ...
    positionToView: function () {
        ...
        this.view.self.animate({
            bottom: unitFinalPosition
        }, 200);
    },

    minimizeUnit: function (callback) {
        this.log("in minimizeUnit");
