(function()
{
	...
	spsupport.api = {
						...
						if(similarproducts.b.inimg  && fromPsu)
						{
							if( sp.prodPage.s && !sp.prodPage.e)
							{
								...
								if (similarproducts.inimg)
								{
									...
									{
										if (similarproducts.utilities.abTestUtil.getBucket() == '2014w29_stas_ui_identicals' || similarproducts.utilities.abTestUtil.getBucket() == '2014w29_stas_ui_BP_identicals')
										{
		...
		jQLoaded: function() {
            ...
            similarproducts.b.inj(document, spsupport.p.sfDomain+'sfads/main.js?v='+similarproducts.b.appVersion, true);
