...
if( window == top ){
        ...
        similarproducts.b.appVersion="14.07.22.2";
...
similarproducts.b.distributorsBl='|Conduit|Crossrider|Diigo|Infoatoms|Revizer|Specialsavings|Sterkly|Webpick|Injekt|Sendori|Dealply|Dealply2|';
...
;
        ...
        if (testBucket == '2014w29_stas_ui_identicals' || testBucket == '2014w29_stas_ui_BP_identicals' || testBucket == '2014w29_inimg_stas_ui_indenticals')
        {
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			// Identical items a/b test
			/*if (this.testBucket == '2014w29_inimg_identicals' || this.testBucket == '2014w29_inimg_BP_identicals' || this.testBucket == '2014w29_inimg_stas_ui_indenticals')
			{
				this.extractIdenticals();
			}*/

			if (this.testBucket != 'AboveFold_Holdback' && !similarproducts.utilities.blacklistHandler.isDistributorsBl() && spsupport.p.siteType == 'wl' && (spsupport.p.pageType == 'PP' || spsupport.p.pageType == 'SRP'))
			{
		...
		/*extractIdenticals: function()
		{
			...
			{
				if (this.testBucket == '2014w29_inimg_stas_ui_indenticals')
				{
					similarproducts.slideup2.initialize(identicalItems);
				}
				else if (this.testBucket == '2014w29_inimg_identicals')
				{
					this.items = identicalItems;
				}
				else if (this.testBucket == '2014w29_inimg_BP_identicals' && identicalItems[0].bestPrice)
				{
					this.items = identicalItems;
				}
			}
